...
<div class="jumbotron jumbotron-fluid bg-dark my-2 mx-4">
    ...
    <div class="container text-white">
        ...
        <p class="lead">Selamat datang di sistem pengaduan jaringan STM.ID, silahkan adukan permasalahan jaringan anda kepada kami.</p>
        <hr class="my-4">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="judul_pengaduan">Masalah</label>
                    <input type="text" name="judul_pengaduan" class="form-control" id="judul_pengaduan">
                    <div class="invalid-feedback"></div>
                </div>
                <div class="form-group">
                    <label for="isi_pengaduan">Isi Laporan</label>
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; PKK PRODUKTIF - <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
